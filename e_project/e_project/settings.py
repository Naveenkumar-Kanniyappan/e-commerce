...
WSGI_APPLICATION = 'e_project.wsgi.application'  # keep as-is
...
# Optional: extra dirs for development
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
# RAZORPAY SETTINGS
# -----------------------------
RAZORPAY_KEY_ID = os.environ.get("RAZORPAY_KEY_ID", "rzp_test_RYWoW6Qhfumipl")
RAZORPAY_KEY_SECRET = os.environ.get("RAZORPAY_KEY_SECRET", "BZxF4LeNhi6F1NONvKPyanSK")
